  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="flex flex-col gap-5 sm:flex-row items-start justify-between mb-4">
          ...
          <div className="sm:w-auto"> <Button variant="outline"
              size="sm"
              onClick={() => router.push(`/events/${event.slug}`)}
              className="gap-2 flex-1"><Eye className="w-4 h-4"/>View</Button></div>
        </div>
        ...
        {stats.isEventToday && !stats.isEventPast && (
          <Button
            size="lg"
            // variant="outline"
            className="mb-8 w-full gap-2 h-10 bg-linear-to-r from-orange-500 via-pink-500 to-red-500 hover:scale-[1.02]"
